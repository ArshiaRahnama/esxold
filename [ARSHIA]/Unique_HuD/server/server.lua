...
-- Coin balance comes straight from CoinSystem's own callback
-- (Coin-System:GetCoin) now, called directly from the client -- no need
-- for a separate GetCC middleman here.
