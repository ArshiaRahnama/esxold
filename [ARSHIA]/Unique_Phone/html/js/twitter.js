...
$(document).on('click', '.twitter-header-tab', function (e) {
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('http://Unique_Phone/ClearMentions');
        }
        ...
        if (PressedTwitterTab == "twitter-self") {
            $.post('http://Unique_Phone/GetSelfTweets', JSON.stringify({}), function (selfdata) {
...
$(document).on('click', '.tweet-delete', function (e) {
    ...
    $.post('http://Unique_Phone/DeleteTweet', JSON.stringify({
        id: id,
    }));

    $.post('http://Unique_Phone/GetSelfTweets', JSON.stringify({}), function (tweets) {
...
$(document).on('click', '#send-tweet', function (e) {
    ...
    if (TweetMessage != "" || TweetUrl != "") {
        ...
        $.post('http://Unique_Phone/PostNewTweet', JSON.stringify({
...
$(document).on('click', '#send-photo', function (e) {
    ...
    $.post('http://Unique_Phone/PostNewImage', JSON.stringify({}),
        function (url) {
...
$(document).on('click', '.hashtag-tag-text', function (e) {
    ...
    if (!HashtagOpen) {
        ...
        $.post('http://Unique_Phone/GetHashtagMessages', JSON.stringify({
            hashtag: Hashtag
