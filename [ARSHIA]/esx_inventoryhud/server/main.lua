...
AddEventHandler('inventory:core:swapItemSlots', function(fromName, fromIsWeapon, toName, toIsWeapon, targetSlot, fromSlot)
    local src = source
    local xPlayer = ESX.GetPlayerFromId(src)
    ...
    local oldSlot = fromEntry.slot or fromSlot
