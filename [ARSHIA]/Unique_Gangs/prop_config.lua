...
PropConfig                            = {}
PropConfig.DrawDistance               = 15.0
PropConfig.MarkerType                 = 1
PropConfig.MarkerSize                 = { x = 1.2, y = 1.2, z = 1.0 }
PropConfig.MarkerColorVeh             = { r = 0, g = 255, b = 0 }
PropConfig.MarkerColorVehDel          = { r = 255, g = 0, b = 0 }
