...
SellerConfig.itemsForSaleSeparated = {
    ...
    salomon = {price = 600, image = url.."salomon.png"},
    meygoo = {price = 850, image = url.."meygoo.png"},
    alidaie = {price = 11500, image = url.."alidaie.png"},
    jolbak = {price = 300, image = url.."jolbak.png"},
    henmeat = {price = 5000, image = url.."henmeat.png"},
    rabbitmeat = {price = 20000, image = url.."rabbitmeat.png"},
    gazellemeet = {price = 20000, image = url.."gazellemeet.png"},
    eaglemeet = {price = 30000, image = url.."eaglemeet.png"},

    -- Shekar

    headeoghab = {price = 40000, image = url.."headeoghab.png"},
    goshteoghab = {price = 10000, image = url.."goshteoghab.png"},
    headeaho = {price = 40000, image = url.."headeaho.png"},
    goshteaho = {price = 10000, image = url.."goshteaho.png"},
    posteaho = {price = 20000, image = url.."posteaho.png"},
    headekhargush = {price = 40000, image = url.."headekhargush.png"},
    goshtekhargush = {price = 10000, image = url.."goshtekhargush.png"},
    postekhargush = {price = 20000, image = url.."postekhargush.png"},
    headerottweiler = {price = 40000, image = url.."headerottweiler.png"},
    goshterottweiler = {price = 10000, image = url.."goshterottweiler.png"},
    posterottweiler = {price = 20000, image = url.."posterottweiler.png"},
    headehusky = {price = 40000, image = url.."headehusky.png"},
    goshtehusky = {price = 10000, image = url.."goshtehusky.png"},
    postehusky = {price = 20000, image = url.."postehusky.png"},
    headecougar = {price = 40000, image = url.."headecougar.png"},
    goshtecougar = {price = 10000, image = url.."goshtecougar.png"},
    postecougar = {price = 20000, image = url.."postecougar.png"},
    headepig = {price = 40000, image = url.."headepig.png"},
    goshtepig = {price = 10000, image = url.."goshtepig.png"},
    postepig = {price = 20000, image = url.."postepig.png"},
    headecoyote = {price = 40000, image = url.."headecoyote.png"},
    goshtecoyote = {price = 10000, image = url.."goshtecoyote.png"},
    postecoyote = {price = 20000, image = url.."postecoyote.png"},
...
SellerConfig.itemsForSaleDrugdealer2 = {
    ...
    heroine = {price = 6400, image = url.."heroine.png"},
    meth = {price = 7100, image = url.."meth.png"},
