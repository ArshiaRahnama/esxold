                ...
                target = tonumber(args[1])
                    ...
                    if target then
                        ...
                        if name then
							...
							--TriggerClientEvent('select',args[1], true)
							--Admins[source] = false
                            ...
                            for i=1, #xPlayers, 1 do
                                ...
                                if xP.permission_level > 0 then
                                    --TriggerClientEvent('chatMessage', xPlayers[i], "", {255, 0, 0}, "^4[^1AdminSpect^4]^2Admin ^3" .. GetPlayerName(source) .. " ^2Roye ^1"..GetPlayerName(args[1]).." ^2Spect Shod")
                                end
                            end
...
RegisterCommand('csp', function(source)
    ...
    if xPlayer.permission_level >= 1 then 
        ...
        for i=1, #xPlayers, 1 do
            local xP = ESX.GetPlayerFromId(xPlayers[i])
            if xP.permission_level > 0 then
                --TriggerClientEvent('chatMessage', xPlayers[i], "", {255, 0, 0}, "^4[^1AdminSpect^4]^2Admin^3 " .. GetPlayerName(source) .. " ^2Az Spect Kharej Shod.")
            end
        end
