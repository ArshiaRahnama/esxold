                ...
                if Config.objects[i].objName then
                    ...
                    if Config.objects[i].multiSeat then
                        OxParams ={
                            ...
                            minZ = Config.objects[i].points[1].z,
                            maxZ = Config.objects[i].points[1].z + Config.objects[i].thickness,
    ...
    Citizen.CreateThread(function()
        ...
        while InUse do
            ...
            if InUse then
                ...
                if IsControlJustPressed(0, Config.SmoothCancelSit ) then
                ...
                if IsControlJustPressed(0,Config.OpenmenuWhileSitting )  then
                ...
                if Config.AllowChairCamera then
                    if IsControlJustPressed(0, Config.StartChairCamera )  then
                        if not cam then
                            StartChairCam()
                            radius = 1.5
                        else
