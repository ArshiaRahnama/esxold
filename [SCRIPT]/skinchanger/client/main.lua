...
---------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	{label = "Face 1",                name = 'face_1',        value = 0,    min = 0,  zoomOffset = 0.6,   camOffset = 0.65}, --
	{label = "Face 2",                name = 'face_2',        value = 0,    min = 0,  zoomOffset = 0.6,   camOffset = 0.65}, --
	{label = "Face 3",                name = 'face_3',        value = 0,    min = 0,  zoomOffset = 0.6,   camOffset = 0.65}, --
...
function ApplySkin(skin, clothes)
  ...
  if Character['sex'] == 1 then
    if Character['hair_1'] == 0 then SetPedComponentVariation(PlayerPedId(), 2, 39 + 0, Character['hair_1'], 2)
    elseif Character['hair_1'] == 1 then SetPedComponentVariation(PlayerPedId(), 2, 39 + Character['hair_1'], 0, 2)
    elseif Character['hair_1'] == 2 then 
      SetPedComponentVariation(PlayerPedId(), 2, 39 + Character['hair_1'], 0, 2)
      if hats == 0 then
        SetPedPropIndex(PlayerPedId(), 0, 5, 0, 2)
      end
    elseif Character['hair_1'] == 3 then SetPedComponentVariation(PlayerPedId(), 2, 39 + Character['hair_1'], 0, 2)
    elseif Character['hair_1'] == 38 then SetPedComponentVariation(PlayerPedId(), 2, 2, 0, 2)
    elseif Character['hair_1'] == 39 then SetPedComponentVariation(PlayerPedId(), 2, 1, 0, 2)
    elseif Character['hair_1'] == 40 then SetPedComponentVariation(PlayerPedId(), 2, 0, 0, 2)
    elseif Character['hair_1'] >= 24 then SetPedComponentVariation(PlayerPedId(), 2, Character['hair_1'] + 1, 0, 2)
    elseif Character['hair_1'] > 3 then SetPedComponentVariation(PlayerPedId(), 2, Character['hair_1'], 0, 2) end
  else
