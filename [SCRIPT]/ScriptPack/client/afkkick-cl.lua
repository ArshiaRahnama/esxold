				...
				if distance <= 2 and ESX.GetPlayerData()['IsDead'] ~= 1 then
					...
					if info.warnings >= 900 then
						if not info.warned then
							...
							TriggerEvent("chatMessage", "[SYSTEM]", {255, 0, 0}, "^0Shoma ^2" .. info.timer .. " ^0saniye digar be elaat ^1AFK ^0bodan kick mishavid, lotfan az makan feli khod ta hengami ke peygham afk ra daryaft konid jabeja shavid ya be soal robero javab dahid ^3/afk ^2" .. info.maths.a .. "^0+^4" .. info.maths.b .. "^0")
							info.warned = true
						else
