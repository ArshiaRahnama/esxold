...
Citizen.CreateThread(function()
	...
	-- while true do
		-- Wait(100)
		-- ESX.TriggerServerCallback("Stress-System:GetStress", function(StressNumber)
			-- Stress.Num = StressNumber
		-- end)
		-- ESX.TriggerServerCallback('esx_license:checkLicense', function(lic)
			-- licweapon = lic
		-- end, GetPlayerServerId(PlayerId()),"shooting")
	-- end
