...
RegisterCommand("lazer", function(source, args)
	...
	while true do
        ...
        if deleteLazer then
            ...
            if hit and (IsEntityAVehicle(entity) or IsEntityAPed(entity) or IsEntityAnObject(entity)) then
                ...
                DrawText3Dlazer(entityCoord.x, entityCoord.y, entityCoord.z, "Obj: " .. entity .. " Model: " .. GetEntityModel(entity).. " \n[~g~E~s~] For Delete Obj", 2)
...
DrawText3Dlazer = function(x, y, z, text, lines)
