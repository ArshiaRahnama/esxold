...
TriggerEvent('es:addAdminCommand', 'weather', 5, function(source, args, user)
    if source == 0 then
...
TriggerEvent('es:addAdminCommand', 'blackout', 5, function(source, args, user)
    if source == 0 then
...
TriggerEvent('es:addAdminCommand', 'morning', 5, function(source, args, user)
    if source == 0 then
...
TriggerEvent('es:addAdminCommand', 'noon', 5, function(source, args, user)
    if source == 0 then
        print("For console, use the \"/time <hh> <mm>\" command instead!")
        return
    end
...
TriggerEvent('es:addAdminCommand', 'evening', 5, function(source, args, user)
    if source == 0 then
        print("For console, use the \"/time <hh> <mm>\" command instead!")
        return
    end
...
TriggerEvent('es:addAdminCommand', 'night', 5, function(source, args, user)
    if source == 0 then
        print("For console, use the \"/time <hh> <mm>\" command instead!")
        return
    end
...
TriggerEvent('es:addAdminCommand', 'time', 5, function(source, args, user)
    if source == 0 then
