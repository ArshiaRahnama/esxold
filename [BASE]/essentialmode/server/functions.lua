...
ESX.CreatePickupCrafting = function(type, name, sc, label, x, y, z)
	local count = 1
	local components = nil
    local pickupId = (ESX.PickupId == 65635 and 0 or ESX.PickupId + 1)
	if type == 'item_weapon' then count = sc.ammo components = sc.components else count = sc end
...
local weaponsObj = {
    ...
    {name = "pizzamo", obj = "prop_pizza_box_02"},
    {name = "pizzama", obj = "prop_pizza_box_02"},
    {name = "snack", obj = "prop_ld_snack_01"},
    {name = "chips", obj = "v_ret_ml_chips2"},
    {name = "burger", obj = "prop_cs_burger_01"},
    {name = "gps", obj = "prop_cs_tablet"},
    ...
    {name = "money", obj = "prop_money_bag_01"},
