...
FinanceOffice3 = {
    ...
    Safe = {
        doorHeadingL = 126.0,
        Position = {x = -1554.08, y = -573.7122, z = 108.5272},
        ...
        Open = function(doorSide)
            ...
            elseif (doorSide:lower() == "right") then FinanceOffice3.Safe.isRightDoorOpen = true
                ...
                Citizen.Trace("[xCoore_IPL] Warning: " .. doorSide .. " is not a correct value. Valid values are:")
        ...
        SetDoorState = function(doorSide, open)
            ...
            if (doorHandle == 0) then
                Citizen.Trace("[xCoore_IPL] Warning: " .. doorSide .. " safe door handle is 0")
                return
            end
