Locales['en'] = {
  ...
  ['boat_shop_bought'] = '~h~Shoma Yek ~y~Qayeq~s~  ~b~%s~s~ Be Qeymat ~g~$%s~s~',
  ['boat_shop_nomoney'] = 'Shoma Pool Kafi ~r~Barai Kharid~s~ Qayeq Nadarid!',
  ['confirm_no'] = 'no',
  ['confirm_yes'] = 'yes',
  ...
  ['garage_taken'] = '~h~~g~Qayeq Az Parking Kharej Shod',
  ['garage_stored'] = '~h~~y~Qayeq Dar Parking Shoma Park Shod',
  ['garage_noboats'] = '~h~~r~Shoma Qayeq Nadarid Be Foroshgah Ye Sar Bezan',
