Locales['fr'] = {
  ...
  ['air_shop_bought'] = 'vous avez ~y~acheté~s~ le ~b~%s~s~ pour ~g~$%s~s~',
  ['air_shop_nomoney'] = 'vous n\'avez pas les moyens ~r~pour acheter~s~ ce bateau !',
  ['confirm_no'] = 'non',
  ['confirm_yes'] = 'oui',
  ...
  ['garage_noairs'] = 'vous n\'avez aucun bateau ici ! Rendez-vous au ~y~magasin de bateaux~s~ pour en acheter un.',
