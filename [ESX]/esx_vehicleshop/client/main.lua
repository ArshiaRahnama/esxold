  ...
  function StartShopRestriction()
	  Citizen.CreateThread(function()
		  while IsInShopMenu do
			  ...
			  DisableControlAction(27, 182, true) -- Disable seatbelt
			  DisableControlAction(0, 182, true) -- Disable seatbelt
		  end
	  end)
  end
  ...
  function OpenShopMenu()
	  ...
	  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		  ...
		  if ESX.PlayerData.gang.name ~= 'nogang' then
			elements = {
				{label = 'Parking Ro Entekhab Konid', value = 'no'},
	  ...
	  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reseller', {
			  ...
			  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'set_vehicle_owner_sell_amount', {
				  ...
				  if amount == nil then
					  ...
					  if closestPlayer == -1 or closestDistance > 3.0 then
						  ...
						  TriggerServerEvent('esx_biscarylling:sendBill', GetPlayerServerId(closestPlayer), 'society_cardealer', _U('car_dealer'), tonumber(data2.value))
					  end
				  end
			  end, function (data2, menu2)
				  menu2.close()
		  ...
		  elseif action == 'set_vehicle_owner_sell' then
			  ...
			  if closestPlayer == -1 or closestDistance > 3.0 then
				  ...
				  if Config.EnableOwnedVehicles then
					  TriggerServerEvent('esx_vehicleshop:setVehicleOwnedscaryPlayerId', GetPlayerServerId(closestPlayer), vehicleProps)
			  ...
			  if closestPlayer == -1 or closestDistance > 3.0 then
				  ...
				  ESX.TriggerServerCallback('esx:getOtherPlayerData', function (xPlayer)
					  ...
					  if Config.EnableSocietyOwnedVehicles then
						  TriggerServerEvent('esx_vehicleshop:setVehicleOwnedscarySociety', xPlayer.job.name, vehicleProps)
						  ESX.ShowNotification(_U('vehicle_set_owned', vehicleProps.plate, GetPlayerName(closestPlayer)))
					  else
						  ESX.ShowNotification(_U('vehicle_sold_to', vehicleProps.plate, GetPlayerName(closestPlayer)))
					  end
  ...
  function OpenBossActionsMenu()
	  ...
	  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reseller',{
		  ...
		  if data.current.value == 'boss_actions' then
			  TriggerEvent('esx_society:openBosscarysMenu', 'cardealer', function(data2, menu2)
				  menu2.close()
			  end)
		  ...
		  if CurrentAction == nil then 
			  ...
			  if IsControlJustReleased(0, Keys['E']) then
				  ...
				  elseif CurrentAction == 'resell_vehicle' then
					...
					if GetPedInVehicleSeat(CurrentActionData.vehicle, -1) == PlayerPedId() then
