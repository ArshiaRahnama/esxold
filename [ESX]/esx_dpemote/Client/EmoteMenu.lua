...
if Config.MenuPosition then
  ...
  elseif Config.MenuPosition == "left" then
    menuPosition = lefttPosition
  end
end
...
mainMenu = NativeUI.CreateMenu("Emote", "", menuPosition["x"], menuPosition["y"], Menuthing, Menuthing)
...
function OpenEmoteMenu()
  if ESX.GetPlayerData().IsDead then return end
