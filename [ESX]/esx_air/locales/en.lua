Locales['en'] = {
  ...
  ['air_shop_bought'] = '~h~Shoma Yek ~y~Air~s~  ~b~%s~s~ Be Qeymat ~g~$%s~s~',
  ['air_shop_nomoney'] = 'Shoma Pool Kafi ~r~Barai Kharid~s~ Air Nadarid!',
  ['confirm_no'] = 'no',
  ['confirm_yes'] = 'yes',
  ...
  ['garage_taken'] = '~h~~g~Air Az Parking Kharej Shod',
  ['garage_stored'] = '~h~~y~Air Dar Parking Shoma Park Shod',
  ['garage_noairs'] = '~h~~r~Shoma Air Nadarid Be Foroshgah Ye Sar Bezan',
