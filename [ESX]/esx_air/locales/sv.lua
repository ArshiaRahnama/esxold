Locales['sv'] = {
  -- shop
  ['air_shop'] = 'båtaffär',
  ['air_shop_open'] = 'tryck ~INPUT_CONTEXT~ för att öppna ~y~båtaffären~s~.',
  ['air_shop_confirm'] = 'köp <span style="color: yellow;">%s</span> för <span style="color: orange;">%s SEK</span>?',
  ['air_shop_bought'] = 'du har ~y~köpt~s~ en ~b~%s~s~ för ~g~%s SEK~s~',
  ['air_shop_nomoney'] = 'du har ~r~inte råd~s~ för denna båt!',
  ['confirm_no'] = 'nej',
  ['confirm_yes'] = 'ja',
  ...
  ['garage_noairs'] = 'du har inga lagrade båtar! Besök ~y~båtaffären~s~ för att köpa båtar.',
