...
Config_fbi.EnableESXIdentity          = false
Config_fbi.EnableSocietyOwnedVehicles = false
Config_fbi.EnableLicenses             = true

Config_fbi.EnableHandcuffTimer        = false
Config_fbi.HandcuffTimer              = 10 * 60000

Config_fbi.EnableJobBlip              = true
Config_fbi.EnablePoliceFine           = true
