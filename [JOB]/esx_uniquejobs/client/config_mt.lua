...
Config_mt.DrawDistance               = 20.0
Config_mt.MarkerType                 = 21
Config_mt.MarkerTypeveh              = 36
Config_mt.MarkerTypevehdel           = 24
Config_mt.MarkerTypeboss             = 22
Config_mt.MarkerSize                 = { x = 1.5, y = 1.5, z = 1.0 }
Config_mt.MarkerColor                = { r = 50, g = 50, b = 204 }
