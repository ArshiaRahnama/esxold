...
Config_sheriff.DrawDistance               = 20.0
Config_sheriff.MarkerType                 = 21
Config_sheriff.MarkerTypeveh              = 36
Config_sheriff.MarkerTypevehdel           = 24
Config_sheriff.MarkerTypeboss             = 22
Config_sheriff.MarkerSize                 = { x = 1.5, y = 1.5, z = 1.0 }
Config_sheriff.MarkerColor                = { r = 193, g = 175, b = 158 }
...
Config_sheriff.sheriffStations = {
...
Config_sheriff.AuthorizedItems = {
	Shared = {
