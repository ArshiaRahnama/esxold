...
for k, v in pairs({
  ...
  ['vehicle_list']              = 'Parking',
  ['work_wear']                 = 'Lebas Kar',
  ['civ_wear']                  = 'Lebas Shakhsi',
  ...
  ['open_actions']              = 'Dokme ~INPUT_CONTEXT~ Jahat Baz Kardan ~y~Parking~s~.',
  ['open_actions_heli']              = 'Dokme ~INPUT_CONTEXT~ Jahat Baz Kardan ~y~Parking~s~.',
  ['open_cloark']               = 'Dokme ~INPUT_CONTEXT~ Jahat Baz Kardan ~y~Komod Lebas~s~.',
  ['open_stock']                = 'Dokme ~INPUT_CONTEXT~ Jahat Baz Kardan ~y~Inventory~s~.',
  ['open_boss']                 = 'Dokme ~INPUT_CONTEXT~ Jahat Baz Kardan ~y~Boss Action~s~.',
  ['harvest']                   = 'harvest',
  ...
  ['billing']                   = 'Billing',
  ['billing_sent']			    = 'Shoma Be Fard Ghabz Dadid!',
  ['hijack']                    = 'Hijack',
  ['repair']                    = 'Repair',
  ['clean']                     = 'Clean',
  ['imp_veh']                   = 'Impound',
  ['place_objects']             = 'Spanw Objects',
  ...
  ['veh_stored']                = 'Dokme ~INPUT_CONTEXT~ Jahat Gozashtan Mashin Dar ~y~Parking.~s~',
