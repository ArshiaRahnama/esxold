...
for k, v in pairs({
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~doa~s~',
  -- Vehicle interaction
  ...
  ['doa_distress_message'] = 'PANIC alarm tavasot yeki az doa ha feretade shod, CODE 1',
  -- DOA stuff
  ['sbullet_wear'] = 'DOA Bullet Proof Vest',
  ['doa_wear'] = 'DOA Outfit',
