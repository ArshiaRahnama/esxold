...
for k, v in pairs({
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~judge~s~',
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['judge_stock'] = 'judge Stock',

  ['remove_prop'] = 'press ~INPUT_CONTEXT~ to delete the object',
  ['map_blip'] = 'judge Station',
  ['unrestrained_timer'] = 'you feel your handcuffs slowly losing grip and fading away.',

  ['alert_judge'] = 'judge alert',
  ['phone_judge'] = 'judge',

  ['distress_sent'] = 'Panic alarm shoma ferestade shod!',
  ['judge_distress_message'] = 'PANIC alarm tavasot yeki az judge ha feretade shod, CODE 1',

  ['sbullet_wear'] = 'Judge Bullet Proof Vest',
  ['judge_wear'] = 'Judge Outfit',
