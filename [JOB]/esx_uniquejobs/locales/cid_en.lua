...
for k, v in pairs({
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~cid~s~',
  -- Vehicle interaction
  ...
  ['cid_distress_message'] = 'PANIC alarm tavasot yeki az cid ha feretade shod, CODE 1',
  -- Sheriff stuff
