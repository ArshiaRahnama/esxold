...
-- Off-duty job variants for all 17 businesses + 4 holdings (esx_duty
-- toggles xPlayer.setJob('off'..job, grade) when you clock off, so each
-- of these needs to exist with matching grade numbers or the grade
-- label would show blank/nil while off duty).
REPLACE INTO `jobs` (`name`, `label`, `whitelisted`, `handyservice`, `hasapp`, `onlyboss`) VALUES
	('offuwucafe', 'Off Duty - Cafe UwU', 1, '0', 0, 0),
	('offobsidian', 'Off Duty - Cafe Obsidian', 1, '0', 0, 0),
	('offvoltage', 'Off Duty - Cafe Voltage', 1, '0', 0, 0),
	('offember', 'Off Duty - Restaurant Ember', 1, '0', 0, 0),
	('offanchor', 'Off Duty - Restaurant Anchor', 1, '0', 0, 0),
	('offcrimson', 'Off Duty - Restaurant Crimson', 1, '0', 0, 0),
	('offflourish', 'Off Duty - Bakery Flourish', 1, '0', 0, 0),
	('offgoldcrust', 'Off Duty - Bakery GoldCrust', 1, '0', 0, 0),
	('offstatic', 'Off Duty - Bar Static', 1, '0', 0, 0),
	('offnightjar', 'Off Duty - Bar Nightjar', 1, '0', 0, 0),
	('offfirebrick', 'Off Duty - Pizza Firebrick', 1, '0', 0, 0),
	('offslice', 'Off Duty - Pizza Slice', 1, '0', 0, 0),
	('offfrostbite', 'Off Duty - Bastani Frostbite', 1, '0', 0, 0),
	('offsundae', 'Off Duty - Bastani Sundae', 1, '0', 0, 0),
	('offkoi', 'Off Duty - Sushi Koi', 1, '0', 0, 0),
	('offwasabi', 'Off Duty - Sushi Wasabi', 1, '0', 0, 0),
	('offcarwash', 'Off Duty - Carwash Suds', 1, '0', 0, 0),
	('offmeridian', 'Off Duty - Holding 1', 1, '0', 0, 0),
	('offblacktide', 'Off Duty - Blacktide Logistics', 1, '0', 0, 0),
	('offcratecarry', 'Off Duty - Crate & Carry Distribution', 1, '0', 0, 0),
	('offturfco', 'Off Duty - Holding 2', 1, '0', 0, 0);
