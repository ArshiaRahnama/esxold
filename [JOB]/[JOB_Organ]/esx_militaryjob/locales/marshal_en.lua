...
for k, v in pairs({
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~Marshal~s~',
  -- Vehicle interaction
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['marshal_stock'] = 'marshal Stock',
  -- Misc
  ['remove_prop'] = 'press ~INPUT_CONTEXT~ to delete the object',
  ['map_blip'] = 'marshal Station',
  ['unrestrained_timer'] = 'you feel your handcuffs slowly losing grip and fading away.',
  -- Notifications
  ['alert_marshal'] = 'marshal alert',
  ['phone_marshal'] = 'marshal',
  -- Panic stuff
  ['distress_sent'] = 'Panic alarm shoma ferestade shod!',
  ['marshal_distress_message'] = 'PANIC alarm tavasot yeki az marshal ha feretade shod, CODE 1',
  -- Sheriff stuff
