...
Config_cid.EnableESXIdentity          = true -- enable if you're using esx_identity
Config_cid.EnableNonFreemodePeds      = false -- turn this on if you want custom peds
Config_cid.EnableSocietyOwnedVehicles = false
Config_cid.EnableLicenses             = true -- enable if you're using esx_license
Config_cid.EnableJobLogs              = true -- only turn this on if you are using esx_joblogs

Config_cid.EnableHandcuffTimer        = false -- enable handcuff timer? will unrestrain player after the time ends
Config_cid.HandcuffTimer              = 10 * 60000 -- 10 mins

Config_cid.EnableJobBlip              = true -- enable blips for colleagues, requires esx_society
